...
const handleCourseChange = (courseId) => {
  ...
  return (
    <div className='flex flex-col lg:py-8 py-2 h-[100vh] relative w-full'>
    ...
    <div className='flex flex-col lg:flex-row md:flex-col lg:gap-0 gap-6 items-start justify-between lg:px-8 px-2 mb-8 min-w-full'>
      {/* Main Table */}
      <div className="timetable">
        <div className="time-header">Day/Hour</div>
        <div className="time-header">8:00 - 10:00</div>
        <div className="time-header">10:00 - 12:00</div>
        <div className="time-header">1:00 - 3:00</div>
        <div className="vertical-text">L<br/>U<br/>N<br/>C<br/>H<br/><br/>B<br/>R<br/>E<br/>A<br/>K</div>
        <div className="time-header">3:00 - 5:00</div>
  ...
  className={`rounded-[8px] border-[1px] border-solid p-1 text-[13px] ${course.type === 'elective' ? 'bg-lightGreen border-green' : 'bg-lightBlue border-blue'}`}>{course.title}</div>
            ...
            <div className='flex items-start gap-1'>
              ...
              {/* Progress bar */}
              <div className="bg-lightBlue h-4 w-[100px] rounded-full">
